...
| `/orders` | `Orders.jsx` | Gestión de pedidos (página real) |
| `/entregas` | `Deliveries.jsx` | Cocina → Empaque → Entrega → Express (producción) |
...
- `Deliveries.jsx`: "devolver a empaque" dentro de la subvista Express sigue fallando (referencia fuera de alcance a `markPacked` en `ExpressView`).
...
| Migraciones | `supabase/migrations/20260414_macros_units_only.sql`, `20260607_detail_status.sql`, `20260703_manual_income.sql`, `20260704_rls_policies.sql`, `20260705_payment_status_paid.sql`, `20260719_dashboard_summary_views.sql`, `20260720_monthly_payment_period_dates.sql`, `20260720_close_monthly_payment.sql` |
...
| Cocina/producción | `src/components/Kitchen.jsx`, `Package.jsx`, `Delivered.jsx`, `ProductionPrintReport.jsx`, `src/pages/Deliveries.jsx` |
...
- Bug de "devolver a empaque" en la subvista Express de `Deliveries.jsx`.
