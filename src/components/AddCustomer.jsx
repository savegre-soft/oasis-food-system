...
const AddCustomer = ({ onAdd, initialData }) => {
  ...
  const [lunchPlanType, setLunchPlanType] = useState(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        ...
        if (error) {
          sileo.error('Error al actualizar el cliente');
          console.error(error);
  ...
  return (
    <div
      className="p-8 bg-slate-50 flex flex-col items-center"
      data-gramm="false"
    ...
    >
      ...
      >
        {errorMsg && <p className="text-red-500 font-medium lg:col-span-2">{errorMsg}</p>}
            ...
            <div className="border border-slate-200 rounded-2xl p-5 bg-slate-50 space-y-4">
              ...
              <div className="border border-amber-200 rounded-xl p-4 bg-amber-50">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <PlanToggle
                    value={lunchPlanType}
                    onChange={handleLunchPlanChange}
                    name="lunchPlan"
                  />
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        min="0"
                        value={lunchProtein}
                        onChange={(e) => handleLunchMacroChange('protein', e.target.value)}
                        className={inputClass}
                        placeholder="Ej: 200"
                        required
                      />
                      <select
                        value={lunchProteinUnit}
                        onChange={(e) => setLunchProteinUnit(e.target.value)}
                        className="px-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-800 transition text-sm bg-white"
                      >
                        {MACRO_UNITS.map((u) => (
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        min="0"
                        value={lunchCarb}
                        onChange={(e) => handleLunchMacroChange('carb', e.target.value)}
                        className={inputClass}
                        placeholder="Ej: 150"
                        required
                      />
                      <select
                        value={lunchCarbUnit}
                        onChange={(e) => setLunchCarbUnit(e.target.value)}
                        className="px-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-800 transition text-sm bg-white"
                      >
                        {MACRO_UNITS.map((u) => (
                          <option key={u} value={u}>
              ...
              <div className="border border-indigo-200 rounded-xl p-4 bg-indigo-50">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <PlanToggle
                    value={dinnerPlanType}
                    onChange={handleDinnerPlanChange}
                    name="dinnerPlan"
                  />
                </div>
                <div className="flex flex-col gap-3">
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        min="0"
                        value={dinnerProtein}
                        onChange={(e) => handleDinnerMacroChange('protein', e.target.value)}
                        className={inputClass}
                        placeholder="Ej: 150"
                        required
                      />
                      <select
                        value={dinnerProteinUnit}
                        onChange={(e) => setDinnerProteinUnit(e.target.value)}
                        className="px-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-800 transition text-sm bg-white"
                      >
                        {MACRO_UNITS.map((u) => (
                          <option key={u} value={u}>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        min="0"
                        value={dinnerCarb}
                        onChange={(e) => handleDinnerMacroChange('carb', e.target.value)}
                        className={inputClass}
                        placeholder="Ej: 100"
                        required
                      />
                      <select
                        value={dinnerCarbUnit}
                        onChange={(e) => setDinnerCarbUnit(e.target.value)}
                        className="px-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-800 transition text-sm bg-white"
                      >
                        {MACRO_UNITS.map((u) => (
                          <option key={u} value={u}>
