...
const MacroPanel = ({ label, colorClass = 'amber', macros, overridden, onUpdate, onReset }) => {
  ...
  const inp = 'w-24 px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 bg-white';
  const sel = 'px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 bg-white';
